# What is the SE Code Review Close Questions room
...
* <a id="TOC-common-questions"></a>[Common Questions](#common-questions)
  ...
  * [Why did you invite me to the SECRCVR Request Graveyard room?](#why-do-you-invite-me-to-the-cv-request-graveyard-room)
...
<h2 id="expectations-for-room-owners">Expectations for Room Owners</h2>
 ...
 9. Moves messages or conversations to [CRCQR /dev/null](https://chat.stackexchange.com/rooms/86077/crcqr-dev-null) (the trash room) if necessary.
10. Moves handled moderation requests to the 
    [CRCQR Request Graveyard](https://chat.stackexchange.com/rooms/86076/crcqr-request-graveyard).

<h1 id="common-questions">Common Questions</h1>

<h2 id="what-is-the-so-close-vote-reviewers-chat-room-1"><a id="whatIsSECRCVR"></a>What is the SE Code Review Close Questions room?</h2>
...
<a id="cv-pls-format"></a>The cv-pls is a commonly used format across different chatrooms on Code Review.
...
* [πάντα ῥεῖ](https://chat.stackexchange.com/users/141258/)
* [200_success](https://chat.stackexchange.com/users/90773/200-success)
* [t3chb0t](https://chat.stackexchange.com/users/165913/t3chb0t)
* [Makyen](https://stackoverflow.com/users/3773011)
* [Peilonrayz](https://chat.stackexchange.com/users/154810/peilonrayz)
* [Mast](https://chat.stackexchange.com/users/128223/mast)
...
<h2 id="why-do-you-invite-me-to-the-cv-request-graveyard-room">Why did you invite me to the SECRCVR Request Graveyard room?</h2>
...
[SECRCVR Request Graveyard](https://chat.stackexchange.com/rooms/86076/crcqr-request-graveyard)
...
So, don't be alarmed or feel left out if the invite to the SECRCVR Request Graveyard doesn't 
...
First, check out the 
[chat room's schedule of events](https://chat.stackexchange.com/rooms/info/85306/se-code-review-close-questions-room?tab=schedule). 
It's updated by the room owners and shows the recurring meet-ups. There are two time 
...
When you end-up in an off-topic debate between some regulars that is no longer about the SECRCVR or the moderation it entails or you have an urgency to post one-boxes do know that creating chatrooms is free. Anyone with 100 reputation can create them. 
Please use that option once the discussion is not going to end quickly or if the silliness would destroy the serious matters that take place at the SECRCVR room. 
...
Although that room isn't moderated as strictly as SECRCVR, we like to point you to [Toward a philosophy of Chat](https://meta.stackexchange.com/questions/270587/toward-a-philosophy-of-chat) and [If you're gonna talk Politics, you must respect those who disagree](https://meta.stackexchange.com/questions/289398/if-youre-gonna-talk-politics-you-must-respect-those-who-disagree) to prevent any claims that we suggested that was a no rules chatroom. 
...
* [*-pls Request Generator](https://github.com/SO-Close-Vote-Reviewers/UserScripts/blob/master/SECloseVoteRequestGenerator.user.js) - Add a button to question pages which will send a *-pls request to a chat room (e.g. SECRCVR). 
...
* [Unclosed Request reviewer](https://github.com/SO-Close-Vote-Reviewers/UserScripts/blob/master/UnclosedRequestReview.user.js) - searches all cv-pls requests in SECRCVR and shows the ones that are still open.
...
You can find the code base [here](https://github.com/SO-Close-Vote-Reviewers/SECRCVR-Chatbot). 
...
[from this neat online graph](https://SECRCVR.azurewebsites.net/). An explanation 
